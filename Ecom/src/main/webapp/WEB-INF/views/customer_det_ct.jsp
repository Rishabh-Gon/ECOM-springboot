                ...
                <%
                    ...
                    <div class="cart-item">
    			        ...
    			        <div class="cart-description">
    			          ...
    			          <p class="seller-info">Seller mail: <%=s_mail%></p>
    			          </div>
    			          <div class="cart-description">
    			          <p class="seller-info">Customer: <%=x.getCustomer().getName()%></p>
    			          <p class="seller-info">Customer Id: <%=x.getCustomer().getId()%></p>
    			          <p class="seller-info">Customer mail: <%=x.getCustomer().getEmail()%></p>
    			          </div>
    			          <div class="cart-description">
    			          <p class="stock-info">Available: <%=avlqty%></p>
    			          <p class="stock-info">Price: ₹<%=p_price%></p>
    			          <p class="stock-info">Buying Quantity: ₹<%=bqty%></p>
    			        </div>
